 ...
 *
 * Disassembly of /tmp/dsdt.dat
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006E49 (28233)
 *     Revision         0x02
 *     Checksum         0x0C
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x98261D18, 0x0D)
    ...
    Scope (_SB.PCI0.GP17.XHC0)
    {
        Device (RHUB)
        {
            ...
            Device (PRT2)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (M601 (0x02, One, 0x05, 0x03, 0x0112, Zero))
                }
            }
            ...
            Device (PRT3)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (M601 (0x02, Zero, 0x06, 0x03, 0x0112, Zero))
                }
            }
        }
    }
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (CAM2)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (M601 (0x04, Zero, 0x03, Zero, 0x0105, 0x00AF00E1))
                    }
                }
